...
class Distillery_Network(Model):

    def __init__(self, params):
        'Constructor'
        super(Distillery_Network, self).__init__('Distillery_Network', params)
    ...
    def get_architecture(self, params):
        ...
        initial_model = Input(params['distillery_input_shape'])
        model = initial_model

        dimensions = params['distillery_dimension_list']
        layers = params['distillery_layer_list']
