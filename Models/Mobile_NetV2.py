...
class Mobile_NetV2(Model):

    def __init__(self, params):
        'Constructor'
        super(Mobile_NetV2, self).__init__('Mobile_Net', params)
    ...
    def get_architecture(self, params):
        ...
        initial_model = mobilenet_v2.MobileNetV2()  # TODO: tal vez incluir image_data_format='channels_last'
