...
# Pretrained weights
ZF_UNET_224_WEIGHT_PATH = 'Utils/unet_224x224_weights.h5'
...
def UNET(dropout_val=0.2, weights=None):
    ...
    if (weights == 'generator' or weights is None) and axis == 3 and INPUT_CHANNELS == 3 and OUTPUT_MASK_CHANNELS == 1:
        weights_path =  ZF_UNET_224_WEIGHT_PATH
